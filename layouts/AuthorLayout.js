      ...
      <div className="">
        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          ...
          <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
            ...
            <br />
            <p>
              This is what I am working on right{' '}
              <Link
                href={'/now'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-900"
              >
            ...
            <p className="sm:block md:hidden lg:hidden">
              ...
              related to
              <span className="font-semibold"> Artficial Intelligence, Data Science, Web development and Machine Learning. </span>
            ...
            <p>
              ...
              or{' '}
               <Link
                href={'https://api.whatsapp.com/send?phone=+254768258491&text=hi Kelvin!'}
            ...
            <p>
              ...
              you can see what I use to code with on daily basis 
            </p>
            <br />
            ...
            <p>
              I came up with my own ideas to start a online platform where i can share my knowledge to individuals who want to start learning about programming and data science. Below is the links to access:
              <ul>
                <li>
                  <Link
                    href={''}
                  ...
                  : Here you can signup and login to get started.
                </li>
                <li>
                  <Link
                    href={'https://api.whatsapp.com/send?phone=+254768258491&text=hi Kelvin!'}
                  ...
                  : Here you can request certain notes that i have prepared for different courses.
                </li>
              </ul>
            </p>
          </div>
